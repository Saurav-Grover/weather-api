...
public class ErrorResponse implements Serializable {
   ...
   */
  public ErrorResponse(Integer status, String message, OffsetDateTime timestamp) {
    this.status = status;
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Location parameter is required", description = "Human-readable error message", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull @Valid 
  @Schema(name = "timestamp", description = "Error occurrence timestamp", requiredMode = Schema.RequiredMode.REQUIRED)
